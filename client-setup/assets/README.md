...
The v1.5.0 release ZIP includes the four verified Bayshore-specific files below. `OpenParrot64.dll` is intentionally not included or replaced; use the version supplied by the installed TeknoParrot release.
