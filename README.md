...
The universal configurator backs up and edits the existing WMMT6 user profile. It does not generate a second GameProfile. The safe launcher starts AMAuth directly, outside OpenParrot injection:
